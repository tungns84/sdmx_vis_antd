export default {
  meta: {
    ...
    links: [
      {
        href: 'http://dotstat-sdg-nsiws.azurewebsites.net/rest/data/MA_545,MILLED_RICE,1.0/ASIKHM002+ASIKHM001../?dimensionAtObservation=AllDimensions&startPeriod=2013&endPeriod=2018',
        rel: 'self',
      },
    ],
  },
            ...
            values: [
              {
                ...
                links: [
                  {
                    href: 'http://dotstat-sdg-nsiws.azurewebsites.net/rest/codelist/MA_545/FREQ/1.0/A',
        ...
        observation: [
          {
            ...
            values: [
              {
                ...
                links: [
                  {
                    href: 'http://dotstat-sdg-nsiws.azurewebsites.net/rest/codelist/MA_545/CL_PROVINCES/1.0/ASIKHM001',
                    urn: 'urn:sdmx:org.sdmx.infomodel.codelist.Codelist=MA_545:CL_PROVINCES(1.0)ASIKHM001',
                    rel: 'self',
                  },
                ],
                annotations: [0],
              },
              {
                ...
                links: [
                  {
                    href: 'http://dotstat-sdg-nsiws.azurewebsites.net/rest/codelist/MA_545/CL_PROVINCES/1.0/ASIKHM002',
                    urn: 'urn:sdmx:org.sdmx.infomodel.codelist.Codelist=MA_545:CL_PROVINCES(1.0).ASIKHM',
                    rel: 'self',
                  },
                ],
                annotations: [1],
              },
              {
                ...
                links: [
                  {
                    href: 'http://dotstat-sdg-nsiws.azurewebsites.net/rest/codelist/MA_545/CL_PROVINCES/1.0/ASIKHM',
                    urn: 'urn:sdmx:org.sdmx.infomodel.codelist.Codelist=MA_545:CL_PROVINCES(1.0).ASIKHM',
                    rel: 'self',
                  },
                ],
            ...
            links: [
              {
                href: 'http://dotstat-sdg-nsiws.azurewebsites.net/rest/codelist/MA_545/CL_PROVINCES/1.0',
